local owners = {"RSFernandes1"} -- Are able to set admins who can ban/etc... using :pa name
local admins = {"RSFernandes1"} -- Sets admins who can use ban/kick/admin or shutdown
